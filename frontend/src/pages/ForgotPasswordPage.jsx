...
const ForgotPasswordPage = () => {
  ...
  const { isLoading, message, error, forgotPassword, setError } =
    useAuthStore();
        ...
        <div className="p-8">
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center">
              ...
              {message && (
                <div className="mb-4 p-3 bg-green-500 bg-opacity-20 border border-green-500 rounded-lg text-white font-semibold text-center">
                  {message}
                </div>
              )}
